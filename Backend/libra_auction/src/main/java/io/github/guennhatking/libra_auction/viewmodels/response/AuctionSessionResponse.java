...
public class AuctionSessionResponse {
    ...
    private List<AuctionSessionResponse.AttributeDTO> attributes;

    private Integer total_bids;
    private Integer total_participants;

    // Nested class for attributes (same as ProductResponse)
    ...
    public List<AuctionSessionResponse.AttributeDTO> getAttributes() {
        return attributes;
    }

    public void setAttributes(List<AuctionSessionResponse.AttributeDTO> attributes) {
